...
public class Item : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Debug.Log(actingPlayer.isFixer);
        // Debug.Log(health);
        // Debug.Log(timer);
...
//        GetComponent<Renderer>().material.color = Color.gray;
    ...
    void OnCollisionEnter (Collision col) {
     ...
     void setMeshes(){
         ...
         if(meshNum == 0){
             //Pulling items from path didn't work
            // string path = "Assets/Scripts/Prefabs/Breakables/FBrokenPrefab.prefab";
            // brokenItem = (GameObject)Resources.Load(path,typeof(GameObject));
            // string path2 = "Assets/Scripts/Prefabs/Breakables/FFixedPrefab.prefab";
            // fixedItem = (GameObject)Resources.Load(path2,typeof(GameObject));
